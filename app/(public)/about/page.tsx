...
const DEV_TEAM = {
  mn: [
    { name: "Бат-Эрдэнэ", role: "Вэб хөгжүүлэгч", initial: "Б", instagram: "https://www.instagram.com/_batuka_7/?hl=en" },
    { name: "Бат-Энх", role: "UI/UX дизайнер", initial: "Б", instagram: "https://www.instagram.com/plutolzy/?hl=en" },
  ],
  en: [
    { name: "Bat-Erdene", role: "Web Developer", initial: "B", instagram: "https://www.instagram.com/_batuka_7/?hl=en" },
    { name: "Bat-Enkh", role: "UI/UX Designer", initial: "B", instagram: "https://www.instagram.com/plutolzy/?hl=en" },
  ],
};
            ...
            {devTeam.map((m) => (
              <div key={m.name} className="border border-[--color-rule] rounded-2xl p-6 bg-white">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 mt-3 text-gray-400 hover:text-[#E1306C] transition-colors"
