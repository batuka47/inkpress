...
export default async function ArticlePage({ params }: Props) {
  ...
  return (
    <ArticleContentClient
      ...
      coAuthors={(((article as typeof article & { article_authors?: { authors: typeof article.authors }[] }).article_authors ?? []).map(r => r.authors).filter((a): a is NonNullable<typeof article.authors> => a != null))}
