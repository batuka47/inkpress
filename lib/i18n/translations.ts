...
export const translations = {
  mn: {
    ...
    // Subscribe page
    subscribePage_title:    "AmjiltPress-д бүртгүүлэх",
    ...
    aboutHeroSubtitle: "AmjiltPress нь уншигчиддаа үнэнч байх, мэдээллийг гоёмсог хэлбэрээр дамжуулах зорилготой бие даасан мэдээний хэвлэл юм.",
    aboutMission_label: "Манай эрхэм зорилго",
    aboutMission_p1: "Бид AmjiltPress-ийг байгуулахдаа мэдээний салбар хоёр зүйлийг буруу хийсэн гэдэгт итгэсэн: хурдны төлөө нарийвчлалаа золиослож, дарааллын товшилтын төлөө дизайнаа золиослосон. Бид хоёуланг нь дахин барьж байна.",
    ...
    // Footer
    footerCopy: "AmjiltPress. Бүх эрх хуулиар хамгаалагдсан.",
  },
  ...
  en: {
    ...
    // Subscribe page
    subscribePage_title:    "Subscribe to AmjiltPress",
    ...
    // About page
    aboutHeroLabel:    "About AmjiltPress",
    aboutHeroHeadline: "News as it should be read.",
    aboutHeroSubtitle: "AmjiltPress is an independent news publication committed to rigorous reporting, elegant presentation, and an unwavering loyalty to its readers.",
    aboutMission_label: "Our Mission",
    aboutMission_p1: "We started AmjiltPress because we believe the news industry got two things badly wrong: it sacrificed accuracy for speed, and design for clicks. We are rebuilding both.",
    ...
    // Footer
    footerCopy: "AmjiltPress. All rights reserved.",
  },
} as const;
